...
class GeminiBrandVisibilityInput(TypedDict, total=False):
    """Input for Gemini Brand Visibility."""
...
class GeminiBrandVisibilityData(BaseModel):
    ...
    citations: list[GeminiBrandVisibilityCitation] | None = Field(
        default=None,
    ...
    competitors: list[GeminiBrandVisibilityCompetitor] | None = Field(
        default=None,
    ...
    model: str | None = Field(
        default=None,
        description="Gemini model that generated the answer. Populated whenever the provider has data for the entity. Present whenever the upstream returns this record.",
    )
    ...
    web_search_triggered: bool | None = Field(
        ...
        description="Whether Gemini used web search for the answer. Populated whenever the provider has data for the entity. Present whenever the upstream returns this record.",
    )


class GeminiBrandVisibilityCitation(BaseModel):
    ...
    end_index: int | None = Field(
        default=None,
        alias="endIndex",
        description="End character offset of the citation evidence.",
    )
    ...
    snippet: str | None = Field(
        default=None, description="Source evidence snippet when supplied."
    )
    start_index: int | None = Field(
        default=None,
        alias="startIndex",
        description="Start character offset of the citation evidence.",
    )
...
class GeminiBrandVisibilityCompetitor(BaseModel):
    model_config = ConfigDict(extra="allow", populate_by_name=True)
...
class GeminiNamespace:
    ...
    def brand_visibility(
        ...
        **input: Unpack[GeminiBrandVisibilityInput],
    ) -> RunResult[GeminiBrandVisibilityData]:
        ...
        Example:
            res = client.gemini.brand_visibility(brand="OpenAI", competitors=["Anthropic", "Google DeepMind", "Meta"], country="US", domain="openai.com", prompt="What is OpenAI and who are its main competitors?")
        """
        raw = self._client._run_raw(  # pyright: ignore[reportPrivateUsage]
            "gemini.brand_visibility", dict(input), options
        )
        return RunResult[GeminiBrandVisibilityData].model_validate(raw)
