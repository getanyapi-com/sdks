...
try {
  ...
  writeFileSync(
    ...
    [
      ...
      "  void unkResult;",
      "",
      "  // Discovery routing facts are gateway-owned and optional for older gateways.",
      "  const catalog = await client.catalog();",
      "  const failover: boolean | undefined = catalog[0]?.failover;",
      "  const excludesCallerDelay: boolean | undefined =",
      "    catalog[0]?.excludesCallerDelay;",
      "  const healthWindow: string | undefined = catalog[0]?.lanes[0]?.health?.window;",
      "  void failover;",
      "  void excludesCallerDelay;",
      "  void healthWindow;",
      "}",
      "void main;",
      "",
