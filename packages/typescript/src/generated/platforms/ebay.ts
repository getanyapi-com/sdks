...
export interface EbayProductItem {
  ...
  availability?: string;
  /**
   * True when the seller accepts Best Offer on this listing.
   */
  ...
  brand?: string;
  /**
   * eBay category path the listing sits in.
   */
  categories?: string[];
  /**
  ...
  /**
   * Global Trade Item Number (UPC/EAN) as listed.
   */
  gtin?: string;
  /**
  ...
  image?: string;
  /**
   * All listing images, primary first.
   */
  images?: EbayProductImage[];
  /**
  ...
  price?: number;
  /**
   * eBay catalog product identifier the listing is matched to.
   */
  productId?: string;
  /**
  ...
  shippingCost?: number;
  /**
   * Seller subtitle shown under the listing title.
   */
  subtitle?: string;
  /**
  ...
  title: string;
  /**
   * UTC epoch timestamp in seconds (Unix time). Multiply by 1000 for a JS Date in milliseconds. When the listing was last modified.
   */
  updatedUtc?: number;
  /**
...
export interface EbayProductFullItem {
  ...
  condition?: string;
  /**
   * ISO country code of the eBay marketplace the listing is on.
   */
  countryCode?: string;
  /**
   * ISO currency code of the price (e.g. USD, GBP).
...
export interface EbaySoldListingsItem {
  ...
  condition?: string;
  /**
   * ISO country code of the eBay marketplace the sale happened on.
   */
  countryCode?: string;
  /**
