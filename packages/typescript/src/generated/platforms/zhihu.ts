...
export interface ZhihuAnswerData {
  ...
  authorToken?: string;
  /**
   * Canonical URL of the author's Zhihu profile.
   */
  authorUrl?: string;
  /**
   * Author identifier.
  ...
  /**
   * Full body text of the answer, with HTML markup stripped.
   */
  text?: string;
  /**
...
export interface ZhihuQuestionAnswersAnswer {
  /**
   * One-line headline the author shows on their Zhihu profile.
   */
  authorHeadline?: string;
  /**
   * Author avatar URL.
  ...
  id: string;
  /**
   * Zhihu ID of the question the answer belongs to.
   */
  questionId?: string;
  /**
   * Title of the question the answer belongs to.
   */
  questionTitle?: string;
  /**
   * Save count.
...
export interface ZhihuSearchArticlesArticle {
  ...
  id: string;
  /**
   * Number of times the article was saved to a collection.
   */
  saves?: number;
  /**
   * Full body text of the article, with HTML markup stripped.
   */
  text?: string;
  /**
