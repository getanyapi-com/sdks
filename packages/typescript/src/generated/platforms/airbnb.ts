...
export interface AirbnbSearchItem {
  /**
   * Listing description written by the host.
   */
  description?: string;
  /**
  ...
  /**
   * Airbnb host identifier.
   */
  hostId?: string;
  hostName?: string;
  /**
   * Average rating across the host other listings (0-5).
   */
  hostRating?: number;
  /**
   * Number of reviews across the host other listings.
   */
  hostReviewsCount?: number;
  /**
   * Whether Airbnb has verified the host identity.
   */
  ...
  rating?: number;
  /**
   * Accuracy sub-rating (0-5).
   */
  ratingAccuracy?: number;
  /**
   * Check-in sub-rating (0-5).
   */
  ratingCheckin?: number;
  /**
   * Cleanliness sub-rating (0-5).
   */
  ratingCleanliness?: number;
  /**
   * Communication sub-rating (0-5).
   */
  ratingCommunication?: number;
  /**
   * Location sub-rating (0-5).
   */
  ratingLocation?: number;
  /**
   * Value sub-rating (0-5).
   */
  ratingValue?: number;
  reviewsCount?: number;
  roomType?: string;
...
export interface AirbnbSearchImage {
  /**
   * Photo caption.
   */
  caption?: string;
